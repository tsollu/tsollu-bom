package com.tsollu.jpa.service.filter;
 ...
 * </pre> Due to problems with the type conversions, the descendant classes should be used, where
 * the generic type parameter is materialized.
 *
...
public class RangeFilter<FIELD_TYPE extends Comparable<? super FIELD_TYPE>>
     ...
     * </p>
     *
     * @param filter a {@link org.muyie.framework.data.jpa.service.filter.RangeFilter} object.
     */
     ...
     * </p>
     *
     * @return a {@link org.muyie.framework.data.jpa.service.filter.RangeFilter} object.
     */
    ...
    public boolean equals(final Object o) {
        ...
        return Objects.equals(greaterThan, that.greaterThan) && Objects.equals(lessThan, that.lessThan)
    ...
    @Override
    public int hashCode() {
        return Objects.hash(super.hashCode(), greaterThan, lessThan, greaterThanOrEqual,
            lessThanOrEqual);
    }
